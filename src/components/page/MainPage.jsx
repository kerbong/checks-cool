...
기존의 잼잼에 있던, 다양한 기능들도, <b>교사만 👉 [We-T]</b> /  <b>학생과 함께 👉 [Wi-S]</b> 로 나누어 담았습니다! 메뉴를 누르셔서 직접 탐색해보세요~!! <br/><br/>2.<br/> We-T 메뉴와 Wi-S 메뉴의 이름<br/>(두~세글자)을 추천해주세요!!!<br/><br/>* 최대한, 빠르게 개발하고 수정하느라.. 모든 테스트를 거치지 못했습니다ㅠㅠ 기존 기능이기에.. 잘 작동할 것이라 생각하고, 저도 주중에 테스트 해보겠습니다! <br/><br/> 
3.<br/><b> 원하는 학생을 먼저 배치해두고 랜덤처럼 뽑는</b>, 비밀기능이 추가되었습니다!!<br/> 자세한 기능설명은 <b>[Wi-S] - [자리뽑기] - 추가하기에서 '사용방법'</b>을 확인해주세요! <br/><br/>
